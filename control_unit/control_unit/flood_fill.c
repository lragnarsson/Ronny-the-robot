...
/*
 * Swaps the pointer new_wavefront and current_wavefront.
 */
...
/*
 * Resets all the values in ff_map.
 */
...
/*
 * Updates the current_rout variable with a route to the destination.
 * Calculates this route from data generated by one of the flood fill algotithms below.
 */
...
/*
 * Floods the maze on known paths until a destination is reached.
 */
...
/*
 * Floods the maze on known paths until an unmapped square is reached.
 */
...
/*
 * Floods the maze on known AND unexplored paths to find an optimistic guess for a shortest route back to the start.
 */
