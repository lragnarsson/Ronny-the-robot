 ...
 * ------------------------------
 * This file contains the function handle_received_messages() which ich called when messages are received on the I2C-bus.
 * It also parses the sensor data received and calculates control errors.
 * ------------------------------ 
