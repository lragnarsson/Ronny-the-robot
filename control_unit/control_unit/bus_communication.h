...
volatile int16_t current_derivative_left;
volatile int16_t current_derivative_right;
...
volatile int16_t previous_distance_left;
volatile int16_t previous_distance_right;
